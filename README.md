...
一个轻盈、简约的浏览器首页，具有搜索功能、网站快捷方式和壁纸切换功能。支持直接使用和作为浏览器扩展两种方式。
...
2. 在搜索框中输入关键词，选择搜索引擎，点击搜索按钮或按回车键进行搜索
3. 点击快捷方式区域的"+"按钮添加自定义网站快捷方式
4. **壁纸功能**：
   - 点击壁纸切换按钮更换壁纸
   - 壁纸切换时保持当前背景，加载成功后才切换新壁纸
   - 每次进入页面会随机选择壁纸
5. 鼠标悬停在快捷方式上，点击右上角的"×"删除快捷方式
